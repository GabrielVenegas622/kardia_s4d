...
# El orden en preparar: ['NORM', 'MI', 'INJ', 'ISC', 'ARRY', 'STTC', 'CD', 'HYP']
CLASES_DIAGNOSTICO = ['Normal', 'Infarto al Miocardio', 'Lesión', 'Isquemia', 'Arritmia', 'Cambios en ST/T', 'Trastorno de Conducción', 'Hipertrofia']
# --------------------
